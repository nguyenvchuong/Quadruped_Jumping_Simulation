...
log_dir = '072322021612' # update every 10ms --> failed
...
class DummyQuadrupedEnv(gym.Env):
    ...
    def __init__(self, dummy_env_config):
        ...
        self.env = ImitationGymEnv(observation_space_mode="MOTION_IMITATION_EXTENDED2_CONTACTS_HISTORY", render=True,
                                   record_video=False, task_env= None)
...
write_out_path = 'exported_models/072322021612/'
